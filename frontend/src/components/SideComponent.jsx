...
const SideComponent = () => {
  ...
  const sidebarLinks = [
    ...
    { to: "/addTask", label: "Add Task", icon: "➕" },
    { to: "/today", label: "Today", icon: "📅" },
    { to: "/upcoming", label: "Upcoming", icon: "⏳" },
    { to: "/filter&labels", label: "Filter & Search", icon: "🔍" },
    { to: "/completed", label: "Completed & Expired", icon: "✅" },
  ];
  ...
  return (
    <>
      ...
      <button
        className="fixed top-4 left-4 z-50 p-2 bg-black rounded-full"
